...
def writeconf(taskid):
    ...
    conf.set("settings", "dongtai", taskinfo.dongtai)
    conf.set("settings", "delay_time", taskinfo.delay_time)
    conf.set("settings", "zuhe_link", taskinfo.zuhe_link)
    conf.set("settings", "zengliang", taskinfo.zengliang)
